...
-- 4. 知识库分类
-- ==========================================
INSERT INTO knowledge_category (id, name, code, sort_order, status) VALUES (100, '奖助学金', 'scholarship', 5, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO knowledge_category (id, name, code, sort_order, status) VALUES (101, '就业创业', 'employment', 6, 1) ON CONFLICT (id) DO NOTHING;
...
VALUES (50001, '思想汇报模板（详细版）', '适用于发展对象阶段的思想汇报模板。', '党团流程', 'DOCX', 42, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO knowledge_template (id, name, description, category, format, download_count, status)
VALUES (50002, '请假申请表（标准版）', '学院标准请假申请表。', '日常服务', 'DOCX', 36, 1) ON CONFLICT (id) DO NOTHING;

-- ==========================================
-- 7. 首页轮播图
-- ==========================================
INSERT INTO home_banner (id, title, subtitle, target_type, target_id, source_type, sort_order, status, created_by)
VALUES (60001, '国家奖学金开始申报', '奖励优秀学生，每人8000元', 'knowledge', 40002, 'manual', 1, 1, 2002) ON CONFLICT (id) DO NOTHING;
INSERT INTO home_banner (id, title, subtitle, target_type, target_id, source_type, sort_order, status, created_by)
VALUES (60002, '入党申请书撰写规范', '了解入党流程第一步', 'knowledge', 40001, 'manual', 2, 1, 2002) ON CONFLICT (id) DO NOTHING;
INSERT INTO home_banner (id, title, subtitle, target_type, target_id, source_type, sort_order, status, created_by)
VALUES (60003, '暑期社会实践报名中', '乡村振兴·红色教育·社区服务', 'notice', 30002, 'manual', 3, 1, 2002) ON CONFLICT (id) DO NOTHING;

-- ==========================================
-- 8. 给用户发消息
-- ==========================================
INSERT INTO user_message (id, user_id, notice_id, title, summary, read_status, created_at)
VALUES (70001, 3001, 30001, '2026年秋季学期选课通知', '请同学们在规定时间内完成选课操作。', 0, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING;
INSERT INTO user_message (id, user_id, notice_id, title, summary, read_status, created_at)
VALUES (70002, 3001, 30002, '暑期社会实践通知', '鼓励同学们积极参与。', 0, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING;
INSERT INTO user_message (id, user_id, notice_id, title, summary, read_status, created_at)
VALUES (70003, 3001, 30003, '心理健康讲座', '校心理健康中心举办专题讲座。', 0, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING;
INSERT INTO user_message (id, user_id, notice_id, title, summary, read_status, created_at)
VALUES (70004, 3001, 9001, '关于2026春季学期学生事务办理安排', '请同学们按时间节点办理事务。', 0, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING;
INSERT INTO user_message (id, user_id, notice_id, title, summary, read_status, created_at)
VALUES (70005, 3001, 9002, '党团积极分子材料提交提醒', '请本月内完成思想汇报上传。', 0, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING;
INSERT INTO user_message (id, user_id, notice_id, title, summary, read_status, created_at)
VALUES (70006, 3002, 30001, '2026年秋季学期选课通知', '请同学们在规定时间内完成选课操作。', 0, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING;
