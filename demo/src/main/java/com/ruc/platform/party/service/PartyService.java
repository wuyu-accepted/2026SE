...
public interface PartyService {
    ...
    List<PartyReport> listMyReports(Long userId);

    Long createActivityApplication(Long userId, PartyActivityCreateDTO dto);

    List<PartyActivityListItemVO> listMyActivities(Long userId);
